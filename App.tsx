...
const LogoETT = () => (
  <div className="flex flex-col items-start md:items-center scale-[0.7] md:scale-100 origin-left">
    <span className="text-xl md:text-3xl font-mono font-black tracking-tighter text-red-700 dark:text-red-500">
      ET&T
    </span>
    <span className="text-[7px] md:text-[9px] font-bold tracking-[0.1em] text-stone-500 dark:text-slate-400 uppercase text-center -mt-1 leading-tight max-w-[100px] md:max-w-none">
      ...
      <header className="py-3 md:py-6 px-4 md:px-6 border-b border-stone-200 dark:border-slate-800 bg-white/90 dark:bg-[#060a13]/90 sticky top-0 z-50 backdrop-blur-xl">
        <div className="container mx-auto flex justify-between items-center max-w-5xl">
            ...
            <div className="flex items-center gap-3">
              <h1 className="sm:hidden font-serif-display text-sm font-black text-red-800 dark:text-red-600 tracking-tighter uppercase">
                ECOS
              </h1>
              <button 
        ...
        {!scenario || loadingStep !== 'idle' ? (
            <div className="w-full max-w-xl mx-auto space-y-8 animate-in fade-in slide-in-from-top-4 duration-1000">
              <div className="text-center space-y-2">
                <p className="text-stone-500 dark:text-slate-400 text-[9px] md:text-xs font-black tracking-[0.3em] uppercase">Audioguía de Inmersión Histórica</p>
